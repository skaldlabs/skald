...
import { STRIPE_SECRET_KEY, STRIPE_WEBHOOK_SECRET, IS_DEVELOPMENT, TEST } from '@/settings'
import { DI } from '@/di'
...
export const stripeWebhook = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const errorMsg = IS_DEVELOPMENT || TEST ? `Webhook Error: ${err.message}` : 'Invalid webhook signature'
